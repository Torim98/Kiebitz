...
import { games, type Game, type Result, type Source } from "../data/demo";
  ...
  return (
    <div className="mx-auto max-w-[1240px] px-6 py-6">
      <header className="mb-5">
        ...
        <p className="mt-0.5 text-[13px] text-ink3">1.248 Partien · 12 in dieser Ansicht · automatischer Import aktiv</p>
      </header>
              ...
              {filtered.map((g) => (
                ...
                >
                  ...
                  <td className="px-2 text-ink2">
                    {g.opening} <span className="text-ink3">· {g.eco}</span>
                  </td>
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="border-t border-line px-4 py-3">
                <div className="flex items-center justify-between">
                  <div className="text-[13.5px] font-medium">
                    {selected.color === "white" ? "Torim98 – " + selected.opponent : selected.opponent + " – Torim98"}
                  </div>
                  <ResultBadge result={selected.result} />
                </div>
                <div className="mt-1 text-[12px] text-ink3">
                  {selected.opening} ({selected.eco}) · {selected.moves} Züge · {selected.tc}
                </div>
            ...
            <Card title="Notizen">
              ...
              <div className="mt-3 flex gap-2">
                ...
                <ExtLink
                  href={selected.source === "chess.com" ? "https://www.chess.com/games/archive/Torim98" : "https://lichess.org/@/Torim98/all"}
                  label="Original"
                />
              </div>
            </Card>
