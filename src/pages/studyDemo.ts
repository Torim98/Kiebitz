...
export function DEMO_PLAN_STATE(_locale: Locale): StudyState {
  ...
  return {
    ...
    plan: {
      allocation: [
        { area: "play", target: 27, actual: 53, minutes: 65, actualMinutes: 105, evidence: 0.9 },
        { area: "tactics", target: 31, actual: 34, minutes: 74, actualMinutes: 68, evidence: 0.6 },
        { area: "openings", target: 21, actual: 4, minutes: 50, actualMinutes: 8, evidence: 0.5 },
        { area: "endgames", target: 10, actual: 2, minutes: 24, actualMinutes: 3, evidence: 0.3 },
        { area: "analysis", target: 11, actual: 9, minutes: 27, actualMinutes: 18, evidence: 0 },
      ],
      prescriptions: [
        {
          id: "time-trouble",
